...
<script src="{{ URL::asset('js/editor.js') }}" defer></script>

<script src="{{ URL::asset('js/filestack-0.1.10.js') }}" defer></script>
<!-- include vue js -->
<script src="{{ URL::asset('js/vue.js') }}" defer></script>
<!-- <script src="https://unpkg.com/vee-validate@2.0.0-rc.18/dist/vee-validate.js"></script> -->
<script src="{{ URL::asset('js/vue-resource@1.5.1') }}" defer></script>

<link href="{{ asset('css/form_builder.css') }}" rel="stylesheet" defer>
